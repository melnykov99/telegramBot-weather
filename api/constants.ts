...
export const outputMessages = {
    ...
    acceptCity: (city: string) => `Принято ✅ Записал твой город ${city} \nТеперь ежедневно буду отправлять прогноз погоды 😊\n\nМожно запрашивать прогноз вручную на сегодня, завтра 3 и 5 дней, для этого нажимай соответствующие кнопки.\n`
}